        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('branch.create') }}" class="btn btn-success"
                        >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('branch.edit', $branch->id) }}" class="btn btn-info btn-sm">
                                            {{ trans('site.edit') }}
                                            <i
                                        class="fa fa-edit"></i>
                                        </a>
                                 ...
                                 <!-- delete_modal_branch -->
                                 <div class="modal fade" id="delete{{ $branch->id }}" tabindex="-1" role="dialog"
